...
void model (
    ...
    Outcome_DE = Outcome_DE + Average_DE1;
    ...
    while (countDE2 < gen_max ) {                 
		for (int  i = 0; i < NP; i++) {
			...
			Degree_A = Degree[a] + Degree_A;
			Degree_B = Degree[b] + Degree_B;
			Degree_C = Degree[c] + Degree_C;
			Degree_I = Degree[i] + Degree_I;	
	...
	Outcome_DEBA = Outcome_DEBA + Average_DE2;
